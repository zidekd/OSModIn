...
komunikaci modulů. Zároveň by už mělo být dokončováno šasí a další podpůrné části.
...
\begin{figure}[h]
    ...
    \caption{Nákres ADC vzorkování při nedodržení Nyquistovy věty (převzato z \cite{OscilloscopeBasicsPrimer})}
