...
\newacronym{adc}{ADC}{analogově digitální převodník}
\newacronym[longplural={časové základny},shortplural=ČZ]{casz}{ČZ}{časová základna}
\newacronym[longplural={digitální paměťové osciloskopy},shortplural=DSO]{dso}{DSO}{digitalální paměťový osciloskop}
